...
//  ⚠ **「AI 한 번」은 배너가 아니라 정리 화면 머리에 선다** (2026-09-13 · `components/demo-ai-once.tsx` · `POST /demo/ai-once`).
//    DESIGN_BRIEF 는 원래 배너에 [AI 한 번 실행해보기] 를 적었지만, 배너는 모든 화면에 서고 결과(질문 카드)는 정리 화면의
//    말이라 그 화면에 붙였다. 배너는 「읽기 전용」 한 줄 그대로다.
