...
//  ⚠ 파일은 `public/art/` 의 WebP 다 (1536×1024 · 클레이 그림이라 16KB 안팎). 원본 PNG 는 evidence 에.
  ...
  steps: [
    {
      ...
      width: 1536,
      height: 1024,
      alt: '얇은 클레이 판 다섯 장이 쌓여 있고 거기서 나온 검은 실들이 오른쪽의 두꺼운 카드 한 장으로 모이는 그림 — 문서에서 항목을 뽑아 하나로 정리한다',
    },
    {
      src: '/art/step-distribute.webp',
      width: 1536,
      height: 1024,
      alt: '똑같은 두꺼운 클레이 카드 셋이 한 줄로 서 있고 검은 실 하나가 셋을 같은 높이로 꿰뚫는 그림 — 같은 버전이 모두에게 닿는다',
    },
    {
      src: '/art/step-progress.webp',
      width: 1536,
      height: 1024,
      alt: '긴 클레이 레일에 검은 조각이 왼쪽부터 삼분의 일 채워져 있고 옆에 확인 표시가 새겨진 작은 타일이 있는 그림 — 진행은 근거만큼 차고 완료는 사람이 확인한다',
    },
  ] as readonly Artwork[],
} as const
