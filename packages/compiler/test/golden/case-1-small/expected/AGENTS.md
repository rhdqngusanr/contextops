...
> 작년 장애 7건 중 5건이 결제에서 났다.
팀이 제일 먼저 지키는 것은 중복 결제가 없다는 약속이다. <!-- ctx:item_pl_mission rev:3 conf:high src:doc:b1a7d9e0-0000-4000-8000-0000000000a1#120-340 -->
...
<!-- 작업 절차 — .claude/rules/workflow.md 의 본문 -->
## 결제 코드를 고칠 때
